...
import IGameManagerBuilder from "./interfaces/IAppBuilder";
import IAutoService from "./interfaces/IAutoService";
import IGameManager from "./interfaces/IGameManager";

export default class GameManagerBuilder extends GameDependencies implements IGameManagerBuilder {
